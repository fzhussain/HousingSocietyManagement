...
<head>
    ...
    <title>Admin - Housing Society</title>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div class="logo mr-auto">
                <h2 class="text-light" ><a href="{{ route('admin') }}" style="color: aliceblue;"><span>Admin's Dashboard</span></a></h2>
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li><a href="#SendNotice">Send a Notice</a></li>
    ...
    <main id="main">
        ...
        <div  class="container contact" style="padding-bottom: 5%; padding-top: 10%;">
            <div class="section-title" data-aos="fade-down">
                ...
                <h2 id="SendNotice" >Make an Announcement</h2>
            </div>

            <livewire:notice-form />
        </div>
